...
public:
  NodeSession(boost::asio::ip::tcp::socket socket, NodeRoom& room) : _socket(std::move(socket)), _room(room) {  std::cout << "NodeSession C'tor" << std::endl; }
